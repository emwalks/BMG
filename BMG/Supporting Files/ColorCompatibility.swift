...
//  BMG
//
//  Created by Emma Walker - TVandMobile Platforms - Core Engineering on 02/01/2020.
//  Copyright © 2020 Emma Walker - TVandMobile Platforms - Core Engineering. All rights reserved.
//
//  Based on the enum described here: https://noahgilmore.com/blog/dark-mode-uicolor-compatibility/
//  Note that system colors may change in the future so RGB equivlaents may need to be updated
