...
class ShowLogbookDetailViewModel_Tests: XCTestCase {
    ...
    ///refactor such that reuse the rockClimbLoggedScreen
//    func testThatWhenLogbookDetailScreenIsPresentedTheClimbRouteNameIsDisplayed(){
//
...
//        //assert
//        XCTAssertEqual(actualResult, expectedResult, "the Rock Climb route detail exists on MockLogbookShowDetailScreen")
//    }
//
//
}
